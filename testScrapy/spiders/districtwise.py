...
class CandidateDetails(scrapy.Spider):
    name = "district"
    start_urls = [
        'http://myneta.info/andhraPradesh2004/index.php?action=show_candidates&constituency_id=1',
    ]
    ...
    def parse(self, response):
        ...
        for j in range(1, 500):
            next_page = 'http://myneta.info//westbengal2016/index.php?action=show_candidates&constituency_id={}'.format(
                j)
